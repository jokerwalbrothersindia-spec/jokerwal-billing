...
- **GSTIN / PAN print:** Settings → Company Profile mein GSTIN daala hai to woh invoice par print hoga. Agar GST registered nahi hain (GSTIN khaali hai), to niche wala **PAN Number** field bhar dein — GSTIN na hone par invoice par automatically PAN print hoga (dono khaali honge to kuch nahi dikhega).
